...
PRODUCT_PROPERTY_OVERRIDES += \
    ...
    log.tag.perfd=S \
    log.tag.PHService=S \
    log.tag.BluetoothMap=S \
    log.tag.BluetoothA2dpSink=S \
    log.tag.BluetoothAvrcpController=S \
    log.tag.BluetoothHeadsetClient=S \
    log.tag.EventHub=S \
    log.tag.WiredAccessoryManager=S \
    log.tag.NFC=S \
    log.tag.ResourcesManager=S \
    log.tag.BackupManagerService=S \
    log.tag.SELinuxMMAC=S \
    log.tag.FileUtils=S \
    log.tag.EntropyMixer=S \
    log.tag.AppSgstMgrService=S \
    log.tag.KeyguardServiceDelegate=S \
